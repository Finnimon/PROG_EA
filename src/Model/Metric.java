...
public class Metric implements iRepairable
{
     ...
     * @Precondition: {@link TreeComparator#getErlaubteAttributIndize()} contains the param index.
    ...
    {
        if (index == TreeComparator.INDEX_ALTER)
        {
            return getAgeInYears();
        }
        else if (index == TreeComparator.INDEX_KRONE_METER)
        {
            return getTreeTopDiameterMeters();
        }
        else if (index == TreeComparator.INDEX_UMFANG_ZENTIMETER)
        {
            return getCircumferenceCentimeters();
        }
        else if (index == TreeComparator.INDEX_HOEHE_METER)
        {
