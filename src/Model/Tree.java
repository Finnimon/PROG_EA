...
public class Tree implements Comparable<Tree>, iRepairable
{
     ...
     * @throws ElementFaultyException if stringlist.size() != {@link #NOTWENDIGE_ZEILENLAENGE}.
     * @Precondition: The stringList contains {@link #NOTWENDIGE_ZEILENLAENGE} elements.
     * @Postcondition: The {@link Tree} is created. Its values will not be null and it will not throw an exception.
     * @Summary: Factory method for {@link Tree} that parses a list of strings into {@link #Tree(List<String>)} and returns it.
     * @Author: Finn Lindig
     * @Since: 26.02.2024
     */
    @Contract("_ -> new")
     ...
     * @Postcondition: The {@link Tree} is created. Its values will not be null and it will not throw an exception.
     * @Summary: Factory method for {@link Tree} that parses {@link CSVRecord#getRecord()} into {@link #Tree(List<String>)} and returns it.
     * @Author: Finn Lindig
     * @Since: 26.02.2024
     */
    ...
    {
        return new TreeComparator(TreeComparator.INDEX_HOEHE_METER).compare(this, otherTree);
    }
